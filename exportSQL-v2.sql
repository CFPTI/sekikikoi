...
--
-- Hôte : localhost:3306
-- Généré le :  sam. 23 mars 2019 à 11:23
...
(1, 'Nés sous la même étoile', 'https://open.spotify.com/embed/track/66ZtqKhYSA8XyPr0aAUFsm', 1),
...
(16, 'Plus Tony que Sosa', 'https://open.spotify.com/track/20S52xE4HYhqwlqy7tPgRh', 1),
(17, 'Sunday Bloody Sunday', 'https://open.spotify.com/embed/track/6C4LXC9UFH1IKiHYOp0BiJ', 1),
(18, 'LE BLOODY SUNDAY DE 1972', 'https://fr.wikipedia.org/wiki/Bloody_Sunday_(1972)', 6),
...
(27, 'Bohemian Rhapsody', 'https://m.youtube.com/watch?v=fJ9rUzIMcZQ', 1),
(28, 'Doctor Who - The christmas invasion', 'https://www.imdb.com/title/tt0562994/', 2),
(29, 'Doctor Who - Turn Left', 'https://www.imdb.com/title/tt1205436/', 2),
(30, 'London 2012 Olympics: the full musical playlist for the Olympic opening ceremony', 'https://www.telegraph.co.uk/sport/olympics/9341231/London-2012-Olympics-the-full-musical-playlist-for-the-Olympic-opening-ceremony.html', 6),
(31, 'House of Pain, Beef Jerky', 'https://open.spotify.com/embed/track/3TZwjdclvWt7iPJUnMpgcs', 1);
...
INSERT INTO `reference` (`id_reference`, `description`, `id_media_base`, `id_media_ref`, `id_type_reference`) VALUES
...
(18, 'In this episode, the sycorax are beamed down to the planet like in the musical clip of the song. ', 27, 28, 4),
(19, 'The refugees are singing Bohemian Rhapsody.', 27, 29, 4),
(20, 'The Sample of Bohemina Rhapsody is used staring on minute 1:09', 27, 31, 2),
(21, 'The song was used for the Olypmic games in London for the opening and closing ceremony. The dancers are also dressed like Freddy Mercury.', 27, 30, 3);
...
ALTER TABLE `reference`
  ...
  ADD KEY `id_type_ref` (`id_type_reference`);
...
--
ALTER TABLE `reference`
  MODIFY `id_reference` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
ALTER TABLE `reference`
  ...
  ADD CONSTRAINT `reference_ibfk_3` FOREIGN KEY (`id_type_reference`) REFERENCES `type_reference` (`id_type_reference`);
